...
- Reviewed disconnect removes only the selected managed Harness Hook and retains the shared companion Skill. Lifecycle-proven retained companions can be reused on reconnect; modified, stale, unreadable, or unproved trees stop for review.
